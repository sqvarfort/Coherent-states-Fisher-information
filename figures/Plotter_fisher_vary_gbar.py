...
filenamek2 = "data/fisher_gbar2"
filenamek3 = "data/fisher_gbar3"
...
times1 = linspace(0, 3*pi, len(fisherk1))
times2 = linspace(0, 3*pi, len(fisherk2))
times3 = linspace(0, 3*pi, len(fisherk3))
...
def plot_fisher(times, data, chirange, filename):
    ...
    plt.plot(times[0], data[0], '-o', color = 'k', markeredgewidth=0.0,  label = r'$\bar{g}= 1$', markersize = 2)
    plt.plot(times[1], data[1], '-o', color = 'b', markeredgewidth=0.0, label = r'$\bar{g} = 2$', markersize = 2)
    plt.plot(times[2], data[2], '-o', color = 'r', markeredgewidth=0.0, label = r'$\bar{g} = 3$', markersize = 2)

    plt.xticks([pi, 3*pi/2,  2*pi, 5*pi/2, 3*pi], [r'$\pi$', r'$\frac{3\pi}{2}$', r'$2\pi$', r'$\frac{5\pi}{2}$', r'$3\pi$'], size = 40)
    ...
    plt.yticks([-50, 0.0, 100, 200, 300, 400, 500, 600], [' ', r'$0$', r'$100$', r'$200$',  r'$300$', r'$400$', r'$500$', ' '])
    plt.subplots_adjust(bottom=0.15,left = 0.15) 
    #plt.xlim([0, pi/2])
    #plt.ylim([0,300])

    plt.legend(loc = 1)
    path = os.path.join("Fisher_vary_gbar")

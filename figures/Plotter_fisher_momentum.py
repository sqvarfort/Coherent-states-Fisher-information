...
with open(filename00) as f:
     for line in f:
        fisher00.append(line.split(" "))
times00 = linspace(pi, 3*pi, len(fisher00))
...
def plot_fisher(times, data, chirange, filename):
    ...
    plt.xlabel('Time $t$')
    plt.ylabel('Momentum measurement '+ r'$\bar{I}_F(t)$')
    ax = plt.subplot(111)
    ...
    plt.xticks([pi-0.5, pi, 3*pi/2,  2*pi, 5*pi/2, 3*pi], [r' ', r'$\pi$', r'$\frac{3\pi}{2}$', r'$2\pi$', r'$\frac{5\pi}{2}$', r'$3\pi$'], size = 40)
    ...
    plt.yticks([-50, 0.0, 100, 200, 300, 400, 500, 600, 700], [' ', r'$0$', r'$100$', r'$200$',  r'$300$', r'$400$', r'$500$', r'$600$', r'$700$', r' '])
    plt.subplots_adjust(bottom=0.15,left = 0.15) 
    #plt.xlim([0, pi/2])
    #plt.ylim([0,300])

    plt.legend(loc = 2)
    path = os.path.join("Fisher_momentum2")

...
""" Plotting """
plt.plot(times01, fisher01, '-o', color = 'k', markeredgewidth=0.0,  label = r'$\bar{\gamma}= 0.1$', markersize = 12, linewidth=2)
...
ax.annotate(r'$\lambda = 1/2$', xy=(1, 1), xytext=(-100, -36), fontsize=40,
    xycoords='axes fraction', textcoords='offset points',
    bbox=dict(facecolor='white', alpha=0, boxstyle="round,pad=0.4"),
    horizontalalignment='right', verticalalignment='top')


plt.savefig("Fisher_leaky01_momentum.pdf",transparent=True, dpi=600,bbox_inches='tight')
plt.show()

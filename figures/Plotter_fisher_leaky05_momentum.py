...
""" Plotting """
plt.plot(times01, fisher05, '-o', color = 'k', markeredgewidth=0.0,  label = r'$\bar{\gamma}= 0.5$', markersize = 12, linewidth=2)
...
plt.savefig("Fisher_leaky05_momentum.pdf",transparent=True, dpi=600,bbox_inches='tight')
plt.show()

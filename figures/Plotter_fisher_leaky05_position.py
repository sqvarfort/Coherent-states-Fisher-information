...
""" Plotting """
plt.plot(times01, fisher05pos, '-o', color = 'k', markeredgewidth=0.0,  label = r'$\bar{\gamma}= 0.5$', markersize = 12, linewidth=2)
...
ax.annotate(r'$\lambda = 0$', xy=(1, 1), xytext=(-200, -36), fontsize=40,
    xycoords='axes fraction', textcoords='offset points',
    bbox=dict(facecolor='white', alpha=0, boxstyle="round,pad=0.4"),
    horizontalalignment='right', verticalalignment='top')


plt.savefig("Fisher_leaky05_position.pdf",transparent=True, dpi=600,bbox_inches='tight')
plt.show()
